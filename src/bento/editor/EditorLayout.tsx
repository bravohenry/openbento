...
/**
 * [INPUT]: children - React children to render in the editor layout
 * [OUTPUT]: React component - Editor layout with left sidebar and right content area
 * [POS]: Main layout component for editor, provides two-column layout structure
 * 
 * [PROTOCOL]:
...
import { ProfileSection, EditorToolbar } from './index'
...
export const EditorLayout: React.FC<EditorLayoutProps> = ({
    ...
    return (
        <div className="fixed inset-0 w-full h-full flex overflow-hidden bg-white">
            ...
            <div className="h-screen w-[380px] shrink-0 flex flex-col bg-white">
                ...
                {/* Footer content at bottom, above toolbar */}
            ...
            {/* Right Column: Widget Grid (Scrollable) */}
